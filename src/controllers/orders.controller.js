...
export const getOrdersController = async (req, res) => {
    ...
    try {
        const getOrders = await connection.query(`SELECT
            cl.id AS client_id,
        ...
        const result = getOrders.rows.map((i) => {
            return {
                client:{
                    id: i.client_id,
                    name: i.client_name,
...
export const getOrdersByIdController = async (req, res) => {
    const { id } = req.params;

    try {
        const getOrdersById = await connection.query(`SELECT
            cl.id AS client_id,
            cl.name AS client_name,
            cl.adress AS client_adress,
            cl.phone AS client_phone,
